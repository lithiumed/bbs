...
var server_host="192.168.8.109";
var quark_login_api = "http://"+server_host+":8081/user/login";
var quark_getUser_api = "http://"+server_host+":8081/user/message/";
var quark_logout_api = "http://"+server_host+":8081/user/logout";
var quark_register_api = "http://"+server_host+":8081/user";
var quark_upload_api = "http://"+server_host+":8081/upload/image";
var quark_upload_icon_api = "http://"+server_host+":8081/upload/usericon/";
var quark_posts_add_api = "http://"+server_host+":8081/posts";
var quark_posts_get_api = "http://"+server_host+":8081/posts";
var quark_posts_detail_api = "http://"+server_host+":8081/posts/detail/";
var quark_reply_add_api = "http://"+server_host+":8081/reply";
var quark_label_getall_api = "http://"+server_host+":8081/label";
var quark_rank_posts_api="http://"+server_host+":8081/rank/topPosts";
var quark_rank_users_api = "http://"+server_host+":8081/rank/newUsers";
var quark_user_detail_api = "http://"+server_host+":8081/user/detail/";
var quark_user_update_api = "http://"+server_host+":8081/user/";
var quark_user_update_psd_api = "http://"+server_host+":8081/user/password/";
var quark_label_posts_api = "http://"+server_host+":8081/posts/label/";
var quark_webSocket_api = "http://"+server_host+":8081/quarkServer";
var quark_notification_api="http://"+server_host+":8081/notification/";
var quark_chat_webSocket_api = "ws://"+server_host+":8083/websocket";
